...
Draggable = Class.create({
  ...
  initDrag: function(event) {
    ...
    if(Event.isLeftClick(event)) {    
	  ...
	  // ==================================================================================
	  // = THIS CHANGE REQUIRED FOR THE FILE EXPLORER COMPONENT (SOMETHING IS WRONG HERE) =
	  // ==================================================================================
	  if (this.options.fixNestedScroll) {
	    var scrollPos = Element.cumulativeScrollOffset(this.element);
	    this.offset = [0,1].map( function(i) { return (pointer[i] - pos[i] - scrollPos[i]); });
	  } else {
